...
public class ExampleAdapter extends RecyclerView.Adapter<ExampleAdapter.ExampleViewHolder> {
    ...
    private ArrayList<ExQuestion> mExampleList;
    ...
    public ExampleAdapter(ArrayList<ExQuestion> exampleList){
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int i) {
        ExQuestion currentQuestion = mExampleList.get(i);
        holder.mTextView1.setText(String.valueOf(i+1));
        holder.mTextView2.setText(currentQuestion.getQuestion());
